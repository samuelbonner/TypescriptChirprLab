...
export const Post: React.FC<PostChirpProps> = (props: PostChirpProps) => {
    ...
    const postChirp = async () => {
        try {
            ...
            console.log(`There was an error with postChirp in Post.tsx! Specifically ${err}`);
        }
    ...
    return (
        <div className="container">
            <div className="my-3">
                <label htmlFor="user-input" className="form-label">Name?</label>
                <input type="text" className="form-control" id="user-input" aria-describedby="newUserInput" onChange={e => handleNameChange(e)} />
            </div>
            <div className="mb-3">
                <textarea className="form-control" id="message-input" placeholder="Message" onChange={e => handleMessageChange(e)}></textarea>
            </div>
